...
class ProductAdmin(admin.ModelAdmin):
    ...
    @admin.display(ordering='comments_count', description='# counts')
    def num_of_comments(self, product):
        # http://127.0.0.1:8000/admin/store/comment/?product__id=1000
        url = (
    ...
    def clear_inventory(self, request, quaryset, ):
        update_count = quaryset.update(inventory=0)
        self.message_user(
            request,
